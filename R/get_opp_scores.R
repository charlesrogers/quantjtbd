...
#' Computes the opportunity scores at the dataframe level
#'
#' @param your_data_frame input your cleaned dataframe that includes importance and satisfaction columns named in the following format:
#' imp__job_section.job_name
#' sat__job_section.job_name
#'
#' @return table of importance, satisfaction, and opportunity scores
#' @export
#'
#' @examples opp_scores <- get_imp_sat_opp_scores_total_population(your_data_frame)
